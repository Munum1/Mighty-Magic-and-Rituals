...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.dropSelf(ModBlocks.BLACKTHORN_LOG.get());
        this.dropSelf(ModBlocks.BLACKTHORN_WOOD.get());
        this.dropSelf(ModBlocks.STRIPPED_BLACKTHORN_LOG.get());
        this.dropSelf(ModBlocks.STRIPPED_BLACKTHORN_WOOD.get());
        this.dropSelf(ModBlocks.BLACKTHORN_PLANKS.get());
        this.dropSelf(ModBlocks.BLACKTHORN_SAPLING.get());
        ...
        this.add(ModBlocks.BLACKTHORN_LEAVES.get(), block ->
                createLeavesDrops(block, ModBlocks.BLACKTHORN_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
